...
ggplot() +
  geom_point(data = cardio, aes(x = Age_Group, y = Dementia_risk), color = "red") +
  geom_line(data = cardio, aes(x = as.numeric(Age_Group), y = predicted_cardio), color = "red") +

  geom_point(data = no_cardio, aes(x = Age_Group, y = Dementia_risk), color = "blue") +
  geom_line(data = no_cardio, aes(x = as.numeric(Age_Group), y = predicted_non_cardio), color = "blue") +
  ...
  labs(title = "Predicted Risk of Dementia by Age Group, with and without cardiovascular conditions",
         ...
         color = "Presence of Cardiovascular Conditions") +
    theme(legend.position = "bottom")
```
```{r}
